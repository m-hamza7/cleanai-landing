...
const createCustomIcon = (type: string) => {
  ...
  return new L.DivIcon({
    html: `<div style="background-color: ${iconColor}; width: ${iconSize}px; height: ${iconSize}px; border-radius: 50%; border: 2px solid white; box-shadow: 0 2px 6px rgba(0,0,0,0.4);"></div>`,
            ...
            >
              ...
              {mockWasteLocations.map((location) => (
                <Marker
                  ...
                  icon={createCustomIcon(location.type) || undefined}
                >
                  <Popup>
                    <div className="p-2 min-w-48">
                      ...
                      <div className="flex items-center justify-between mb-1">
                        ...
                        <span className={`text-xs font-medium capitalize px-2 py-0.5 rounded ${
                          location.type === 'critical' ? 'bg-red-100 text-red-800' :
                          location.type === 'high' ? 'bg-orange-100 text-orange-800' :
                          location.type === 'medium' ? 'bg-yellow-100 text-yellow-800' :
                          location.type === 'low' ? 'bg-blue-100 text-blue-800' :
